...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0025_relationvenuecharacter_relationvenuecharactertype'),
    ]

    operations = [
        migrations.CreateModel(
            name='RelationVenueGenreType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='A name for the venue - genre relation type', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='RelationVenueGenre',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('relation_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='catalog.RelationVenueGenreType')),
